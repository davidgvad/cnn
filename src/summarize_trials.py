...
def _parse_key_value(lines: List[str]) -> Dict[str, Any]:
    ...
    for line in lines:
        ...
        if key in {
            ...
            "coefficient_max",
            "coefficient_step",
            "coefficient_pairs_searched",
            "min_validation_macro_f1_retention",
            "score_scaling_changed_predictions",
            "r2l_predictions_lost_after_scaling",
            "u2r_predictions_lost_after_scaling",
            "r2l_predictions_gained_after_scaling",
            "u2r_predictions_gained_after_scaling",
            "r2l_threshold",
            "u2r_threshold",
